...
export class PreviewPage {
  ...
  dropDown16:boolean=false;dropDown17:boolean=false;dropDown18:boolean=false;dropDown19:boolean=false;dropDown20:boolean=false;
  ...
  timeSlot9=" ";timeSlot18=" ";timeSlot19=" ";timeSlot20=" ";
  myDate;
                                  ...
                                  env.storage.get('timeSlot16').then(data=>{
                                    ...
                                    env.storage.get('timeSlot17').then(data=>{
                                      ...
                                      env.storage.get('timeSlot18').then(data=>{
                                        ...
                                        env.storage.get('timeSlot19').then(data=>{
                                          env.timeSlot19 = data;
                                          if(data==undefined || data=='undefined'){
                                            this.dropDown19 = true;
                                          }
                                          env.storage.get('timeSlot20').then(data=>{
                                            env.timeSlot20 = data;
                                            if(data==undefined || data=='undefined'){
                                              this.dropDown20 = true;
                                            }
                                            env.timeArray = [];
                                            ...
                                            env.timeArray[18] = {
                                              TIMESLOT: "06:00 PM - 06:30 AM",
                                              NAME: env.timeSlot19,
                                            };
                                            env.timeArray[19] = {
                                              TIMESLOT: "06:30 PM - 07:00 AM",
                                              NAME: env.timeSlot20,
                                            };
                                          });
                                        });
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: () => {
            ...
            {
              if(this.timeSlot17 == this.timeSlot18 || this.timeSlot18 == this.timeSlot19){
                env.presentWarning();
            ...
            {
              if(this.timeSlot18 == this.timeSlot19 || this.timeSlot19 == this.timeSlot20){
                env.presentWarning();
                this.timeSlot19 =null;
              }
              else {
                this.dropDown19 = false;
                env.storage.set('timeSlot19', this.timeSlot19);
              }
            }
            else if(text == 'slot20')
            {
              if(this.timeSlot19 == this.timeSlot20){
                env.presentWarning();
                this.timeSlot20 = null;
              }
              else {
                this.dropDown20 = false;
                env.storage.set('timeSlot20', this.timeSlot20);
              }
            }
