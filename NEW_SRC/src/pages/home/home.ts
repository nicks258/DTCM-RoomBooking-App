...
export class HomePage {
  ...
  i = 0;
  time;
  copart1;copart2;copart18;copart19;copart20;
  ...
  addMeeting(){
    ...
    if(this.timeSlot19 !=undefined || this.timeSlot19 =='undefined'){
      env.storage.set('timeSlot19',this.timeSlot19);
    }
    else {
      env.storage.set('timeSlot19',this.copart19);
    }
    if(this.timeSlot20 !=undefined || this.timeSlot20 =='undefined'){
      env.storage.set('timeSlot20',this.timeSlot20);
    }
    else {
      env.storage.set('timeSlot20',this.copart20);
    }
    ...
    env.nextPage(18,"06:00 PM - 06:30 PM",this.timeSlot19);
    env.nextPage(19,"06:30 PM - 07:00 PM",this.timeSlot20);
    env.nextPage(288,"06:30 PM - 07:00 PM",this.timeSlot20);
  }
                                          ...
                                          env.storage.get('timeSlot18').then(data=>{
                                            ...
                                            env.storage.get('timeSlot19').then(data=>{
                                              ...
                                              env.storage.get('timeSlot20').then(data=>{
                                                this.copart20 = data;
                                                console.log("Last Copart->"+this.copart20);
                                                //TODO API PARSING
